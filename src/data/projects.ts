...
export const projects: Project[] = [
  ...
  },
  {
    ...
    screenshots: [
      "/backend/edusmart-system/02-teacher-dashboard-overview-desktop.png"
    ],
    dashboardScreenshots: [
      {
        src: "/backend/edusmart-system/01-login-page-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/02-teacher-dashboard-overview-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/13-profile-settings-desktop.png",
        alt: {
    ...
    academicScreenshots: [
      {
        src: "/backend/edusmart-system/03-students-list-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/06-grades-management-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/07-assignments-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/08-schedule-desktop.png",
        alt: {
    ...
    frontendScreenshots: [
      {
        src: "/backend/edusmart-system/09-reports-dashboard-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/10-messages-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/11-announcements-desktop.png",
        alt: {
      ...
      {
        src: "/backend/edusmart-system/12-calendar-desktop.png",
        alt: {
