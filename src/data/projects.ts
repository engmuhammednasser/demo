...
export const projects: Project[] = [
  ...
  {
    slug: "ashhalanksa",
    title: "Ashhalan KSA Store",
    titleAr: "متجر أشهلان KSA",
    type: ["woocommerce","wordpress"] as WorkType[],
    category: "E-commerce Website",
    categoryAr: "متجر إلكتروني / E-commerce Website",
    industry: "E-COMMERCE · RETAIL",
    goal: ["Performance", "Sales"],
    summary: "A fully custom-built e-commerce store specializing in hygiene and daily consumer products for homes, restaurants, companies, and institutions in Saudi Arabia. Features product browsing, categories, offers, cart, checkout, and quote requests.",
    summaryAr: "متجر إلكتروني متخصص في بيع منتجات النظافة والاستهلاك اليومي للمنازل، المطاعم، الشركات والجهات المختلفة داخل المملكة العربية السعودية، مع تجربة تسوق سهلة تشمل عرض المنتجات، التصنيفات، العروض، السلة، الدفع، وطلب عروض الأسعار.",
    problem: "The project required a professional e-commerce store that presents Ashhalan products in an organized and user-friendly way, with a fast and clear interface to help customers browse products and offers, add to cart, and complete purchases or request quotes easily.",
    problemAr: "كان المشروع يحتاج إلى متجر إلكتروني احترافي يعرض منتجات أشهلان بطريقة منظمة وسهلة الاستخدام، مع واجهة سريعة وواضحة تساعد العملاء على تصفح المنتجات والعروض، إضافة المنتجات إلى السلة، وإتمام عملية الشراء أو طلب عرض سعر بسهولة.",
    solution: "Developed a fully custom e-commerce store with a theme built completely from scratch, without relying on any ready-made template. The interface, pages, and sections were implemented in a hardcoded fashion for full control over design, performance, user experience, and how products and offers are presented. The build focused on delivering a clear and fast Arabic shopping experience, with organized product categories, highlighted offers and best-sellers, and easy access to cart and social channels.",
    solutionAr: "تم تطوير متجر إلكتروني كامل بثيم مخصص مبني من الصفر بالكامل، بدون الاعتماد على قالب جاهز. تم تنفيذ الواجهة والصفحات والأقسام بشكل Hardcoded لضمان تحكم كامل في التصميم، الأداء، تجربة المستخدم، وطريقة عرض المنتجات والعروض. ركز البناء على تقديم تجربة تسوق عربية واضحة وسريعة، مع تنظيم المنتجات داخل فئات، إبراز العروض والمنتجات الأكثر مبيعًا، وتسهيل الوصول إلى السلة ووسائل التواصل.",
    role: ["Lead Developer"],
    stack: ["Custom Theme", "Hardcoded Front-End", "PHP", "HTML", "CSS", "JavaScript"],
    features: [
      "Fully custom theme built from scratch",
      "Hardcoded front-end without ready-made templates",
      "Complete e-commerce store for product display and sales",
      "Clear product categories (tissues, detergents, cups, bags, rolls)",
      "Organized product pages with pricing and add-to-cart",
      "Offers and best-sellers sections",
      "Arabic UX tailored for the Saudi market",
      "Responsive design for mobile and tablet",
      "Optimized page load speed with minimal plugin dependency",
      "WhatsApp and social media integration for orders and quote requests"
    ],
    featuresAr: [
      "تصميم Custom Theme من الصفر بالكامل",
      "بناء الواجهة والأقسام Hardcoded بدون قالب جاهز",
      "متجر إلكتروني متكامل لعرض وبيع المنتجات",
      "تصنيفات واضحة للمنتجات مثل المناديل، المنظفات، الأكواب، الأكياس والرولات",
      "صفحات منتجات منظمة مع السعر وخيارات الإضافة للسلة",
      "أقسام للعروض والمنتجات الأكثر مبيعًا",
      "تجربة مستخدم عربية مناسبة للسوق السعودي",
      "تصميم متجاوب مع الموبايل والتابلت",
      "تحسين سرعة تحميل الصفحات وتقليل الاعتماد على الإضافات الجاهزة",
      "دمج وسائل التواصل وواتساب لسهولة طلب المنتجات أو عروض الأسعار"
    ],
    screenshots: [
...

  {
    ...
    titleAr: "أشهلان لوجستكس Ashhalan Logistics",
    type: ["nextjs"] as WorkType[],
    category: "Landing Page / Logistics Website",
    categoryAr: "صفحة هبوط / موقع خدمات لوجستية",
    industry: "LOGISTICS · DELIVERY · SHIPPING",
    goal: ["Performance", "Sales"],
    summary: "A professional landing page for Ashhalan Logistics, specializing in parcel delivery, order fulfillment, and shipping solutions within Saudi Arabia. Built with Next.js using a fully custom interface, designed to clearly and quickly present the company's services, build trust, highlight speed and reliability, and facilitate easy contact for clients and businesses.",
    summaryAr: "صفحة هبوط احترافية لشركة Ashhalan Logistics المتخصصة في خدمات النقل اللوجستي، نقل الطرود، توصيل الطلبات، وحلول الشحن داخل المملكة العربية السعودية. تم تنفيذ الصفحة باستخدام Next.js مع بناء واجهة مخصصة بالكامل من الصفر، لعرض خدمات الشركة بشكل واضح وسريع، وإبراز الثقة، السرعة، الأمان، وسهولة التواصل مع العملاء والشركات والمتاجر.",
    problem: "The company needed a clear and direct Landing Page to introduce their logistics services professionally, present the company's value proposition, and demonstrate its capabilities in parcel transport, order delivery, and shipment management within Saudi Arabia. The primary goal was to convert visitors from browsers into potential clients who could easily get in touch or request a service.",
    problemAr: "كانت الشركة تحتاج إلى Landing Page واضحة ومباشرة تعرّف العملاء بخدماتها اللوجستية وتعرض قيمة الشركة بطريقة احترافية، مع توضيح قدرتها على نقل الطرود وتوصيل الطلبات وإدارة الشحنات بكفاءة داخل السعودية. كان الهدف الأساسي هو تحويل الزائر من مجرد متصفح إلى عميل محتمل يتواصل أو يطلب الخدمة بسهولة.",
    solution: "Developed a fully custom Landing Page using Next.js, with all sections and components built hardcoded from scratch without relying on any ready-made template. The page is structured starting with a strong Hero Section presenting the company's message, moving through services, features, and trust signals, culminating in a clear Call To Action for contact and service requests. The custom build provided full control over design, content layout, performance, and user experience, while maintaining a simple, fast interface suited to the nature of transport and logistics companies.",
    solutionAr: "تم تطوير Landing Page مخصصة بالكامل باستخدام Next.js، مع بناء جميع الأقسام والمكونات بطريقة Hardcoded من الصفر بدون الاعتماد على قالب جاهز. تم تنظيم الصفحة بداية من Hero Section قوي يعرض رسالة الشركة، مرورًا بأقسام الخدمات والمميزات ونقاط الثقة، وصولًا إلى Call To Action واضح للتواصل وطلب الخدمة. البناء المخصص وفر تحكمًا كاملًا في التصميم، ترتيب المحتوى، سرعة الأداء، وتجربة المستخدم، مع الحفاظ على واجهة بسيطة وسريعة ومناسبة لطبيعة شركات النقل والخدمات اللوجستية.",
    role: ["Lead Developer"],
    stack: ["Next.js", "React.js", "JavaScript", "HTML", "CSS"],
    features: [
      "Professional custom Landing Page design",
      "Frontend built with Next.js",
      "All sections and components built hardcoded from scratch",
      "No ready-made templates used",
      "Strong Hero Section with clear marketing message",
      "Organized display of transport and delivery services",
      "Highlights of key strengths: speed, trust, security, and reliability",
      "Clear Call To Action for contact and service requests",
      "Simple and straightforward user experience",
      "Responsive design for mobile and tablet",
      "Optimized page load speed and browsing experience",
      "Content structured to drive conversions and attract leads"
    ],
    featuresAr: [
      "تصميم Landing Page احترافية مخصصة",
      "تطوير الواجهة باستخدام Next.js",
      "بناء جميع الأقسام والمكونات Hardcoded من الصفر",
      "تصميم بدون الاعتماد على قالب جاهز",
      "Hero Section برسالة تسويقية واضحة",
      "عرض منظم لخدمات النقل والتوصيل",
      "إبراز نقاط القوة مثل السرعة، الثقة، الأمان والالتزام",
      "Call To Action واضح للتواصل وطلب الخدمة",
      "تجربة استخدام بسيطة ومباشرة",
      "تصميم Responsive متوافق مع الموبايل والتابلت",
      "تحسين سرعة تحميل الصفحة وتجربة التصفح",
      "تنظيم المحتوى لخدمة هدف التحويل وزيادة العملاء المحتملين"
    ],
    screenshots: [
      "/projects/ashhalanlogistics/cover.png",
      "/projects/ashhalanlogistics/home.png",
      "/projects/ashhalanlogistics/section01.png",
      "/projects/ashhalanlogistics/section02.png",
      "/projects/ashhalanlogistics/section03.png"
    ],
