...
export const plugins: PluginItem[] = [
  {
    ...
    screenshots: [
      "/plugins/custom-currency-icon/cover.png",
      "/plugins/custom-currency-icon/1.png",
      "/plugins/custom-currency-icon/2.png",
      "/plugins/custom-currency-icon/3.png",
      "/plugins/custom-currency-icon/4.png",
    ],
  ...
  },
  {
    ...
    screenshots: [
      "/plugins/geidea-payment-gateway/cover.png",
      "/plugins/geidea-payment-gateway/admin-settings.png",
      "/plugins/geidea-payment-gateway/admin-settings2.png",
      "/plugins/geidea-payment-gateway/admin-settings3.png",
      "/plugins/geidea-payment-gateway/admin-settings4.png",
      "/plugins/geidea-payment-gateway/payment-redirect-flow.jpg",
    ],
  ...
  },
  {
    ...
    screenshots: [
      "/plugins/access-trail/cover.png",
      "/plugins/access-trail/screenshots/01.png",
      "/plugins/access-trail/screenshots/02.png",
      "/plugins/access-trail/screenshots/03.png"
    ],
    status: "public-github",
    needsReview: false,
  },
