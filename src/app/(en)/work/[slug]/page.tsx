        ...
        <section className="max-w-6xl mx-auto space-y-8">
          ...
          <FullPageScreenshotPreview
            ...
            screenshots={allScreenshots.slice(1).map((src) => {
              ...
              const isFullPage = ((slug.startsWith("eventgift-") || slug === "botella" || slug === "techmart" || slug === "a2mkw" || slug === "nora24jewelry" || slug === "tbinnovation" || slug === "genedyeg" || slug === "gobe" || slug === "nuc-kw") && !src.includes("header") && !src.includes("هيدر")) || (slug === "ashhalan" && src.includes("home-page"));
              ...
              } else if (slug === "tbinnovation" || slug === "genedyeg" || slug === "gobe" || slug === "nuc-kw") {
